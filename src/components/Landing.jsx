...
transition={{opacity:1,duration:5,delay:5}}  className='h-[100vh] w-full bg-orange relative strength_container'>
            ...
            <video  src="/videos/25fps.mp4" className="w-[100%] h-[100%] object-cover" muted loop autoPlay/>
              <div className='w-[100%] h-screen absolute  top-[0px] left-0 flex flex-col mix-blend-multiply bg-black '>
